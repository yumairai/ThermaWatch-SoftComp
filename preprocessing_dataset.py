...
print("=== MEMULAI PREPROCESSING DATA THERMAWATCH (TARGET: MEI 2026) ===\n")
...
# =========================================================================
# 4. FILTERING OUTLIER EKSTREM LANDSAT
# =========================================================================
...
# =========================================================================
# 5. MERGE DATASET MASTER (LEFT JOIN BERBASIS KALENDER HARIAN MODIS)
# =========================================================================
print("3. Menggabungkan multi-sensor (Memaksa Landsat mengikuti kalender harian MODIS)...")
...
# =========================================================================
# 7. INTERPOLASI TEMPORAL (MENAMBAL JEDA 16 HARI LANDSAT SECARA HALUS)
# =========================================================================
print("5. Mengisi kekosongan data akibat jeda lintasan orbit Landsat & awan...")
...
# =========================================================================
# 8. SUNTIK ELEVASI DAN KALKULASI ANOMALI TERMAL
# =========================================================================
print("6. Menyuntikkan nilai elevasi wilayah dan menghitung anomali termal...")
...
# =========================================================================
# 9. WINDOWING TARGET TIME-SERIES & CUT-OFF TEGAS MEI 2026
# =========================================================================
...
# --- PEMBATASAN AMAN SAMPAI MEI 2026 ---
df_master = df_master[(df_master['date'] >= '2014-01-01') & (df_master['date'] <= '2026-05-31')]

# Dropna ditaruh di paling akhir agar baris sisa pergeseran di akhir Mei dibersihkan otomatis
df_master = df_master.dropna(subset=['Target_Anomali_H1', 'Target_Anomali_H3', 'Target_Anomali_H7'])
# ----------------------------------------

# Ekspor hasil akhir ke CSV
df_master.to_csv('Dataset_(Jan,2014-Mei,2026).csv', index=False)

print("\n=== PROSES PREPROCESSING SELESAI SEMPURNA ===")
print(f"📅 Rentang Data Aktual: {df_master['date'].min().strftime('%Y-%m-%d')} s/d {df_master['date'].max().strftime('%Y-%m-%d')}")
